...
@interface CheckCustomerViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation CheckCustomerViewController
...
//    1婚宴 2会务 3宝宝宴
    ...
    [HTTPTool POST:url parameters:parameters success:^(HTTPResult *result) {
        ...
        if (result.success) {
            InputCustomerViewController *inputVc = [[InputCustomerViewController alloc] init];
