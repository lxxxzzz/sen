...
@interface DJLogViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation DJLogViewController
...
- (void)getLog {
    ...
    NSString *url = [NSString stringWithFormat:@"%@?m=app&c=order&f=dajianOrderFollowList&debug=1", HOST];
